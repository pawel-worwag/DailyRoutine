...
namespace Identity.Persistence.Migrations
{
    ...
    [Migration("20230912185520_User_Personalization")]
    partial class User_Personalization
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Identity.Domain.Client", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Identity.Domain.RedirectionEndpoint", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("Identity.Domain.UserClaim", b =>
                {
                    ...
                    b.HasKey("Id", "ClaimType", "ClaimValue");
            ...
            modelBuilder.Entity("Identity.Domain.Entities.PasswordRecoveryToken", b =>
                {
                    b.HasOne("Identity.Domain.User", "User")
                        .WithMany("_passwordRecoveryTokens")
            ...
            modelBuilder.Entity("Identity.Domain.RedirectionEndpoint", b =>
                {
                    b.HasOne("Identity.Domain.Client", "Client")
            ...
            modelBuilder.Entity("Identity.Domain.User", b =>
                {
                    ...
                    b.Navigation("_passwordRecoveryTokens");
                });
